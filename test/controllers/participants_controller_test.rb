...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference("Participant.count") do
      post participants_url, params: { participant: { name: @participant.name, study_id: @participant.study_id, type: @participant.type } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { name: @participant.name, study_id: @participant.study_id, type: @participant.type } }
